<what-next>
  ...
  <session-notes>
  Four features, two acceptance criteria each. Sign-in is the only must-have; export
  and the theme preference follow it, and telemetry is not wanted in this release.
  </session-notes>
</what-next>
